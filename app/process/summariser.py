...
from app.prompts.summariser.google_ai import generate_google_ai_summariser_system_message, generate_google_ai_summariser_user_message
    ...
    def generate_user_message(
        ...
        match self._llm_type:  
            ...
            case LLMType.OPENAI_GPT3_5:
                ...
                pass
            case LLMType.GEMINI_PRO:
                return generate_google_ai_summariser_user_message(conversation=conversation)
            case LLMType.AWS_BEDROCK_CLAUDE_3_SONNET:
                # TODO
                pass
