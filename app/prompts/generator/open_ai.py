...
def generate_open_ai_summariser_user_message(conversation: Conversation):
    ...
    user_message += "\nGenerate revision notes from the model's response. Avoid referencing the model or the user in your notes aside outside of the context portion. Describe the content as if it is from a textbook:"
